...
public sealed class UiaWorkerClient : IPremiereAutomation
{
    ...
    private static readonly TimeSpan CatalogDeadline = TimeSpan.FromSeconds(8);
    ...
    public object CatalogAdapters(SemanticAdapterCatalogArgs args) => Execute("premiere.adapters.catalog", args, CatalogDeadline, false);
    public object InvokeAdapter(SemanticAdapterInvokeArgs args) => Execute("premiere.adapter.invoke", args, InvokeDeadline, true);
