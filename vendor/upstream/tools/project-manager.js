...
export function getProjectManagerTools(bridgeOptions) {
    return {
        consolidate_and_transfer: {
            description: "Consolidate, copy, or transcode project media using the Project Manager. Useful for archiving or transferring projects.",
            parameters: {
                type: "object",
                properties: {
                    destination_path: {
