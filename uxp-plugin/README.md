...
Choose **Connect** once after opening the panel. It connects directly to the installed localhost bridge on port 17777; no token, file picker, or pairing bootstrap is used.
